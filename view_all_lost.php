...
$lost_items = [];
$sql_lost = "SELECT id, item_name, description, image_path, date_lost, lost_location, category, status FROM lost_items";
$search_params = [];
$search_types = "";
...
if ($stmt_lost) {
    ...
    $_SESSION['error_message'] = "Could not retrieve lost items list.";
}
...
<head>
  ...
  <title>All Lost Items - FoundIt</title>
...
<body>
  <div class="navbar">
    ...
    <div class="search-box">
      <form action="view_all_lost.php" method="GET">
        <input type="text" name="search" placeholder="Search lost items..." value="<?php echo htmlspecialchars($search_query); ?>">
      ...
      <?php foreach ($lost_items as $item): ?>
        <a href="lost_item_view.php?id=<?php echo htmlspecialchars($item['id']); ?>" class="item-card">
          ...
          <div class="item-desc">
            ...
            <div class="item-meta">Lost on: <?php echo htmlspecialchars($item['date_lost']); ?> in <?php echo htmlspecialchars($item['lost_location']); ?></div>
