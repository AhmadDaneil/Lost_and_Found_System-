...
$item_type = 'found'; // Explicitly set for this page
...
if ($item_id) {
    ...
    $_SESSION['error_message'] = "No found item ID provided.";
    header("Location: homepage.php");
    exit();
}
...
<head>
  ...
  <title>Found Item - View</title>
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" rel="stylesheet"/>
  <style>
    /* Your existing CSS for found_item_view.html */
    * {
      margin: 0;
      padding: 0;
...
<body>
  ...
  <div class="content-box">
    ...
    <a href="found_item.html?id=<?php echo htmlspecialchars($item_id); ?>" class="edit-btn" title="Edit Found Item">
      <svg viewBox="0 0 24 24">
    ...
    <div class="top-content">
      ...
      <div class="details-box">
        <div>
          ...
          Found Location: <?php echo htmlspecialchars($item_details[$location_field]); ?></p>
        </div>
    ...
    <div class="status-box">
      ...
      <?php if ($is_owner && $item_details['status'] === 'unclaimed'): // Show status update button only if current user is the owner and status is 'unclaimed' ?>
